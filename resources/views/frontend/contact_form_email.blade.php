...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>Phone:</strong> <a href="tel:{{ $emailData['phone'] }}">{{ $emailData['phone'] }}</a></p>
            <p><strong>Enquiry Type:</strong> {{ $emailData['enquiry'] }}</p>
            <p><strong>Message:</strong> <br> {{ nl2br(e($emailData['message'])) }}</p>
        </div>
