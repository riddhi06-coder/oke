                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('events-listing.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" name="banner_heading" placeholder="Enter Banner Heading" value="{{ old('banner_heading', $event->banner_heading) }}">
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="banner_title" type="text" name="banner_title" placeholder="Enter Banner" value="{{ old('banner_title', $event->banner_title) }}">
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <div class="mt-2">
                                                @if(isset($event->banner_image))
                                                    <img 
                                                        id="imagePreview" 
                                                        src="{{ asset('uploads/events/' . $event->banner_image) }}" 
                                                        alt="Image Preview" 
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="events_title" type="text" name="events_title" placeholder="Enter Events Title" value="{{ old('events_title', $event->events_title) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input 
                                                ...
                                                name="image" 
                                                accept="image/*" 
                                                onchange="previewPageImage(event)"
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="event_loaction" type="text" name="event_loaction" placeholder="Enter Event Location" value="{{ old('event_loaction', $event->event_loaction) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mt-2 mb-4">
                                            ...
                                            <input class="form-control" id="event_date" type="date" name="event_date" value="{{ old('event_date', $event->event_date) }}" required>
