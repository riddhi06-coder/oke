                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('details.update', $business_details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mb-5">
                                            ...
                                            <select class="form-control" id="business_id" name="business_id" required>
                                                ...
                                                @foreach ($businesses as $id => $name)
                                                    <option value="{{ $id }}" {{ old('business_id', $business_details->business_id) == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="banner_label" type="text" name="banner_label" label="banner_label" placeholder="Enter Banner Label" value="{{ old('banner_label', $business_details->banner_label) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <div class="mt-2">
                                                @if ($business_details->banner_image)
                                                    <img id="imagePreview" src="{{ asset('uploads/business-details/' . $business_details->banner_image) }}" alt="Banner Image Preview" style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px;">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <img id="pageimagepreview" 
                                                    src="{{ asset('uploads/business-details/' . $business_details->logo) }}" 
                                                    alt="Image Preview" 
                                                    style="background-color: black; max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px;">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mb-4"> 
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" name="banner_heading" placeholder="Enter Banner Heading" value="{{ old('banner_heading', $business_details->banner_heading) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="year" type="text" name="year" placeholder="Enter No. of Years" value="{{ old('year', $business_details->year) }}">
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="project_completed" type="text" name="project_completed" placeholder="Enter Projects Completed" value="{{ old('project_completed', $business_details->project_completed) }}">
                                        ...
                                        <div class="col-12 mb-5"> <!-- Added mb-5 for larger gap -->
                                            ...
                                            <textarea id="banner_description" name="banner_description" class="form-control summernote">
                                                {{ old('banner_description', $business_details->banner_description) }}
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="industry_label" type="text" name="industry_label" placeholder="Enter Industry Label" value="{{ old('industry_label', $business_details->industry_label) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="industry_heading" type="text" name="industry_heading" placeholder="Enter Industry Heading" value="{{ old('industry_heading', $business_details->industry_heading) }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <!-- Image Preview -->
                                            <div class="mt-2">
                                                @if ($business_details->industry_image)
                                                <img id="IndustryImagepreview" src="{{ asset('uploads/business-details/' . $business_details->industry_image) }}" 
                                                    alt="Image Preview" 
                                                    style="background-color: black; max-width: 50%; height: auto; border: 1px solid #ddd; padding: 5px;">
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mb-4">
                                            ...
                                            <input class="form-control" id="service_heading" type="text" name="service_heading" placeholder="Enter Service Heading" value="{{ old('service_heading', $business_details->service_heading) }}" required>
                                        ...
                                        <table class="table table-bordered" id="serviceTable">
                                            ...
                                            <tbody id="serviceTableBody">
                                                @php
                                                    $existingServiceImages = json_decode($business_details->service_images ?? '[]', true);
                                                    $existingServiceDescriptions = json_decode($business_details->service_descriptions ?? '[]', true);
                                                @endphp

                                                {{-- Display existing service images if available --}}
                                                @if (!empty($existingServiceImages))
                                                    @foreach ($existingServiceImages as $index => $image)
                                                        <tr>
                                                            <td>
                                                                <input class="form-control" type="file" name="service_image[]" accept="image/*" onchange="previewLogoImage(event, this)">
                                                                <img src="{{ asset('uploads/business-details/' . $image) }}" alt="Service Image Preview" class="img-preview"
                                                                    style="background-color: black; max-width: 30%; height: auto; border: 1px solid #ddd; padding: 5px; display: block;">
                                                            ...
                                                            <td>
                                                                <input class="form-control" type="text" name="service_description[]" value="{{ $existingServiceDescriptions[$index] ?? '' }}" placeholder="Enter Service Description" required>
                                                            </td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger" onclick="removeRow(this)">Remove</button>
                                                            </td>
