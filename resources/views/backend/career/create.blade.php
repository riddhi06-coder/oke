                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('page-career.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <h5 class="mt-4 mb-4 d-flex justify-content-between"><strong># Reviews Section Details</strong></h5>
                                         ...
                                         <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="review_heading" type="text" name="review_heading" placeholder="Enter Review Heading" value="{{ old('review_heading') }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="review_title" type="text" name="review_title" placeholder="Enter Review Title" value="{{ old('review_title') }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="rating_heading" type="text" name="rating_heading" placeholder="Enter Rating Heading" value="{{ old('rating_heading') }}" required>
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="ratings" type="text" name="ratings" placeholder="Enter Ratings" value="{{ old('ratings') }}" required>
