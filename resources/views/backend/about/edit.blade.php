        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit About Page Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit About Page Details</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_heading" type="text" name="banner_heading" placeholder="Enter Banner Heading" value="{{ old('banner_heading', $about->banner_heading) }}">
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_title" type="text" name="banner_title" placeholder="Enter Banner" value="{{ old('banner_title', $about->banner_title) }}">
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        @if($about->banner_image)
                                            <div class="mt-2">
                                                <img id="imagePreview" src="{{ asset('uploads/about/' . $about->banner_image) }}" alt="Image Preview" style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="page_heading" type="text" name="page_heading" placeholder="Enter Page Heading" value="{{ old('page_heading', $about->page_heading) }}" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="page_title" type="text" name="page_title" placeholder="Enter Page Title" value="{{ old('page_title', $about->page_title) }}" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="image" type="file" name="image" accept="image/*" onchange="previewPageImage(event)">
                                        <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                        <br>
                                        <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>

                                        <!-- Image Preview -->
                                        @if(isset($about->image) && file_exists(public_path('uploads/about/' . $about->image)))
                                        <div class="mt-2">
                                            <img id="pageimagepreview" src="{{ asset('uploads/about/' . $about->image) }}" alt="Image Preview" style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px;">
                                        </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="card_title" type="text" name="card_title" placeholder="Enter Card Title" value="{{ old('card_title', $about->card_title) }}" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="year" type="text" name="year" placeholder="Enter Year" value="{{ old('year', $about->year) }}" required>
